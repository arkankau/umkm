  ...
  return (
    <div className='py-10 px-15 font-mont flex items-center relative'>
      ...
      <div className='flex items-center  gap-15 absolute left-1/2 transform -translate-x-1/2'>
        <Link className='mx-4 font-normal text-lg hover:text-[#C6AFFF] transition-colors duration-300' href='/'>Home</Link>
        <Link className='mx-4 text-lg hover:text-[#C6AFFF] transition-colors duration-300' href='/about'>Features</Link>
        <Link className='mx-4 text-lg hover:text-[#C6AFFF] transition-colors duration-300' href='/contact'>Team</Link>
      </div>
