...
const EmbeddedMarketingBot = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      {/* Footer */}
      <div className="text-center p-4 text-xs text-gray-600 border-t">
        <div className="flex items-center justify-center space-x-2 mb-1">
          <Brain className="w-3 h-3 text-green-600" />
          <span>Powered by advanced AI models for personalized marketing advice!</span>
        </div>
        <div className="flex items-center justify-center space-x-2">
          <Lightbulb className="w-3 h-3 text-yellow-500" />
          <span>Set your business context for the best personalized advice!</span>
        </div>
      </div>
    </div>
  );
